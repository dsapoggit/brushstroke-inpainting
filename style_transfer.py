...
parser.add_argument('--img_size', '-s', type=int, default=256,
                    help='The smaller dimension of content image is resized into this size. Default: 256.')                    
parser.add_argument('--save_to', '-o', type=str, default='result',
                    help='Storage for results. Default: `result`.')
...
content_layers_default = ['conv1_1', 'conv2_1', 'conv3_1', 'conv4_1', 'conv5_1']
...
if __name__ == '__main__':
    ...
    style_img = image_loader(args.style_img_file)
    content_img = image_loader(args.content_img_file)
